...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-color-picker', __webpack_require__(3));
  Vue.component('detail-color-picker', __webpack_require__(6));
  Vue.component('form-color-picker', __webpack_require__(9));
});
